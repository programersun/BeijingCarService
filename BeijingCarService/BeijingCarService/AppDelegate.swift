...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        */
        ...
        SR_NetOperate.sharedInstance.judgeNetCanConnect { (status) -> Void in
            ...
            {
                self.postNetRecoverNoti()
            }
        }
        
        var isUserLogin = SR_UserInfoDetail.sharedInstance.isUserLogin()
    ...
    /**
    网络恢复，发送通知，注册了通知的列表页面可以刷新（仅限当前列表页面）
    */
    func postNetRecoverNoti()
    {
        NSNotificationCenter.defaultCenter().postNotificationName(String.notyForNetRecoverName(), object: nil)
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("BeijingCarService", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("BeijingCarService.sqlite")
